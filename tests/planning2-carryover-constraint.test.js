...
test('08:55 equal-count tie is deterministic by identity, not list position',()=>{const get=(employee,date)=>shift('09:00',date==='2026-10-02'?'19:10':'15:00'),people=[{id:'z'},{id:'a'}];assert.equal(carryover.rankPlanning2CarryoverCandidates(people,get,'2026-10-02','2026-10-03')[0].id,'a');assert.equal(carryover.rankPlanning2CarryoverCandidates([...people].reverse(),get,'2026-10-02','2026-10-03')[0].id,'a')});
